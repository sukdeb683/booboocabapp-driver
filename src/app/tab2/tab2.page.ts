      ...
      async res => { 
        ...
        res.forEach(element => {
          ...
          this.mydata = {
            ...
            distanceInKm: element['distanceInKm'],
            estimated_amount_passenger: element['estimated_amount_passenger'],
          };
        ...
        if( i > 0){
          ...
          this.presentToastWithOptions("  Info:  ", "No ride has been booked yet or deleted! Please book a ride.", "alert-circle-outline", "close-outline" );
        }
